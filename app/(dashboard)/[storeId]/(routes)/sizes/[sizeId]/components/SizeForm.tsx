...
export const SizeForm = ({ initialData } : SizeFormProps) => {
	...
	// Using useForm and populating default values from initialData while validating them using the SizeFormValue type
	...
	// Function updating Size details / creating size in database
